class DialogueObserver extends Observer{
    ...
    update(observable,object){
      ...
      if (observable.getNom()==="Charlie"){
        ...
        this.view.nom.innerText = "Charlie";
        this.view.box.style.backgroundColor="#0600FF";
      }
      else{
        this.view.texte.style.backgroundColor="#E66E78";
        this.view.nom.innerText=observable.getDescription();
        this.view.box.style.backgroundColor="#E66E78";
      }
